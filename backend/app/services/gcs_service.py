"""Cloud Storage service para imágenes temporales."""
import base64
import uuid
...
class GCSService:
    ...
    async def upload_image(self, image_base64: str, mime_type: str = "image/jpeg") -> str:
        ...
        try:
            ...
            blob.upload_from_string(base64.b64decode(image_base64), content_type=mime_type)
