...
const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { key: "knowledge-base", label: "KB Soporte", icon: BookOpen, path: "/dashboard/knowledge-base", adminOnly: true },
      { key: "servers-knowledge-base", label: "KB Servidores", icon: ServerCog, path: "/dashboard/knowledge-base/servers", adminOnly: true },
